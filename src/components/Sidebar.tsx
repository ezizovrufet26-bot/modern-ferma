  ...
  return (
    <>
      ...
      <button 
        ...
        className="fixed top-6 left-6 z-[100] md:hidden w-12 h-12 bg-white rounded-2xl shadow-xl flex items-center justify-center text-gray-900 border border-gray-100"
      >
